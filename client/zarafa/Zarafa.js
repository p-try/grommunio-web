...
Ext.apply(Zarafa, {
	...
	initializeGlobals: function()
	{
		...
		// Load all settings
        Object.keys(settings).forEach(messageStoreId => container.getSettingsModel(messageStoreId).initialize(settings[messageStoreId]));
		delete settings;
		...
		if ( Ext.isDefined(window.persistentsettings) ){
            Object.keys(window.persistentsettings).forEach(messageStoreId => {
                container.getPersistentSettingsModel(messageStoreId).initialize(window.persistentsettings[messageStoreId]);
            });
