...
/**
 * @class Zarafa.core.ui.widget.AbstractFolderWidget
...
Zarafa.core.ui.widget.AbstractFolderWidget = Ext.extend(Zarafa.core.ui.widget.Widget, {
	...
	constructor: function (config)
	{
		...
		Zarafa.core.ui.widget.AbstractFolderWidget.superclass.constructor.call(this, config);
	},
	...
	initEvents: function ()
	{
		Zarafa.core.ui.widget.AbstractFolderWidget.superclass.initEvents.apply(this, arguments);
		...
		var config = Ext.apply({}, this.configurationConfig || {}, {
			...
			items: [{
				...
				items: [{
					...
					defaultValue: this.get('reloadinterval') || 30,
					listeners: {
						'change': this.onFieldChange,
						scope: this
					},
